...
- **Merge seguro de duplicados B-safe (ADR 0007 — implementado no backend na Sprint 3.33; frontend chega na 3.34).** Endpoint `POST /patients/:id/merge`. Invariantes em vigor no código:
  ...
  - **Fora de escopo (3.33):** seleção campo-a-campo, merge automático sem confirmação, undo/snapshot, qualquer dado clínico, paginação backend de duplicados, frontend (3.34).
