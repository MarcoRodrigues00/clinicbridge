...
| **4.8C** ✅ | Frontend Estoque v0.1 — aba "Estoque" + `InventoryPanel` (hero, filtros, low-stock badge, CRUD owner, movimentos magnitude+direção, histórico). typecheck/build ✅. Validação visual pendente |
