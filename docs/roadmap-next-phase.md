...
| **4.8C** ✅ | Frontend Estoque v0.1 — aba "Estoque" + `InventoryPanel` (hero, filtros, low-stock badge, CRUD owner, movimentos magnitude+direção, histórico). typecheck/build ✅ |
| **4.8D** ✅ | QA/Hardening Estoque v0.1 — revisão UX, greps segurança 0-violations, sanity smoke 8/8. **Fase 4.8 completa.** typecheck/build ✅ |
